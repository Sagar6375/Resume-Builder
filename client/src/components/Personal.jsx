import { User, Globe, Linkedin, BriefcaseBusiness, Phone, MapPin, Mail } from "lucide-react";
import React from "react";

export default function Personal({ data, onChange, removeBackground, setRemoveBackground }) {
    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        <label>
          ...
          <input type="file" accept="image/jpeg, imageg/png" className="hidden" onChange={(e) => handleChange("image", e.target.files[0])} />
        </label>
