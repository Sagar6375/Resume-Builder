...
export const ProfessionalSumaaryForm = ({ data, onChange, setResumeData }) => {
    ...
    <div className="space-y-4">
      ...
      <div className="mt-6">
        ...
        transition-colors resize-none"
          placeholder="Write a compelling professional
        summary that highlights your key strengths and career objectives..."
        />

        <p className="text-xs text-gray-500 max-w-4/5 max-auto text-center">Tip: Keep it concise (3-4 sentences) and focus on your most 
          relevant achievements and skills.</p>
      </div>
    </div>
  );
};
