          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className="absolute bottom-1 text-[11px] text-slat-400
      ...
      {showCreateResume && (
        ...
        >
          <div
            ...
            w-full max-w-sm p-6"
          >
            <h2 className="test-xl font-bold mb-4">Create a Resume</h2>
      ...
      {showUploadResume && (
        ...
        >
          <div
            ...
            w-full max-w-sm p-6"
          >
            <h2 className="test-xl font-bold mb-4">Upload Resume</h2>
      ...
      {editResumeId && (
        ...
        >
          <div
            ...
            w-full max-w-sm p-6"
          >
            <h2 className="test-xl font-bold mb-4">Edit Resume Title</h2>
